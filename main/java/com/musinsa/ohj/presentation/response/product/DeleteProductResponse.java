...
public class DeleteProductResponse extends CommonApiResponse implements ApiResponse<Optional> {

    ApiResponseCode apiResponseCode;

    @Builder
    private DeleteProductResponse(ApiResponseCode apiResponseCode,
                                 String code,
                                 String message) {
    ...
    public static DeleteProductResponseBuilder builder(ApiResponseCode apiResponseCode) {
        return new DeleteProductResponseBuilder().apiResponseCode(apiResponseCode);
    }
