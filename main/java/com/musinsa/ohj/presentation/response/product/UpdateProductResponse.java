...
public class UpdateProductResponse extends CommonApiResponse implements ApiResponse<Optional> {

    ApiResponseCode apiResponseCode;

    @Builder
    private UpdateProductResponse(ApiResponseCode apiResponseCode,
                                 String code,
                                 String message) {
    ...
    public static UpdateProductResponseBuilder builder(ApiResponseCode apiResponseCode) {
        return new UpdateProductResponseBuilder().apiResponseCode(apiResponseCode);
    }
