...
public class DeleteBrandResponse extends CommonApiResponse implements ApiResponse<Optional> {

    ApiResponseCode apiResponseCode;

    @Builder
    private DeleteBrandResponse(ApiResponseCode apiResponseCode,
                                String code,
                                String message) {
    ...
    public static DeleteBrandResponseBuilder builder(ApiResponseCode apiResponseCode) {
        return new DeleteBrandResponseBuilder().apiResponseCode(apiResponseCode);
    }
