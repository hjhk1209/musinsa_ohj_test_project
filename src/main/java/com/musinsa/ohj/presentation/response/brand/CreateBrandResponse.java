...
public class CreateBrandResponse extends CommonApiResponse implements ApiResponse<Optional> {

    ApiResponseCode apiResponseCode;

    @Builder
    private CreateBrandResponse(ApiResponseCode apiResponseCode,
                                String code,
                                String message) {
    ...
    public static CreateBrandResponseBuilder builder(ApiResponseCode apiResponseCode) {
        return new CreateBrandResponseBuilder().apiResponseCode(apiResponseCode);
    }
